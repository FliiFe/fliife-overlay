...
SRC_URI="https://dl.google.com/dl/android/studio/ide-zips/${STUDIO_V}/android-studio-ide-${BUILD_V}-linux.zip"
...
RDEPEND=">=virtual/jdk-1.7
	...
	|| ( >=sys-libs/ncurses-5.9-r101:0/6[tinfo] )
...
src_install() {
	...
	make_desktop_entry ${PN} "Android Studio Canary" ${PN} "Development;IDE"
}
